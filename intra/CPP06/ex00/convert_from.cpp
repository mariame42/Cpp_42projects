...
/*   Updated: 2025/11/09 16:45:57 by meid             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void        convert_from_float(float f, int digits_after_dot)
{
    ...
    std::cout << "float: " << std::fixed << std::setprecision(digits_after_dot) << f << "f" << std::endl;
...
void        convert_from_double(double d, int digits_after_dot)
{
    ...
    if (d > FLT_MAX || d < -FLT_MAX)
        ...
        std::cout << "float: " << std::fixed << std::setprecision(digits_after_dot) << static_cast<float>(d) << "f" << std::endl;
